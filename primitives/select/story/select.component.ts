...
import { PortalDirective } from '../../portal';
import { SelectCompareWith } from '../src/model/select.model';
      ...
      >
        ...
        <ng-container *vacPortal>
          <div *vacSelectVisibility>
            <div vacSelectContent class="absolute w-80 mt-1 rounded-md bg-white shadow-lg z-10">
              <div vacSelectViewport class="py-1 text-sm text-gray-700">
                <div vacSelectGroup>
                  <div vacSelectGroupLabel class="px-4 py-2 text-xs text-gray-500">Grupo 1</div>
                  <vac-select-item value="value1" label="Item 1">Item 1</vac-select-item>
                  <vac-select-item value="value2" label="Item 2" [disabled]="true">Item 2</vac-select-item>
                </div>
                <div vacSelectSeparator class="h-px bg-gray-200"></div>
                <div vacSelectGroup>
                  <div vacSelectGroupLabel class="px-4 py-2 text-xs text-gray-500">Grupo 2</div>
